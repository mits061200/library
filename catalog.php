    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="viewcatalog.php">View Catalog</a>
            </li>
        </ol>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $acquisitionDate = !empty($row['AcquisitionDate']) ? date('M d, Y', strtotime($row['AcquisitionDate'])) : '';
                        $createdAt = !empty($row['CreatedAt']) ? date('M d, Y h:i A', strtotime($row['CreatedAt'])) : '';
                        $updatedAt = !empty($row['UpdatedAt']) ? date('M d, Y h:i A', strtotime($row['UpdatedAt'])) : '';
        ...
        <?php
            ...
            echo "<div class='alert alert-info'>No books found matching your criteria. Please try different search or filter options.</div>";
        }
        ?>
    </div>
